...
export default () => (
  <Page>
    <Section title="Статьи" className={style.article}>
      ...
      Познакомиться с авторскими мыслями полезно, как минимум для решения двух вопросов: разобраться
      в тематике и/или понять, на сколько эксперт в теме и оценить уровень его экспертизы. Все
      статьи, выложенные на этом сайте написаны в разное время и по разным поводам, но все они о тех
      или иных сторонах краудфандинга.
    </Section>
    ...
    >
      ...
      <p>
        ...
        количество людей. И, что важно, обязательно каждый поддержавший идею получают взамен
        ...
        предоплата продукта, который чрез указанный в проекте промежуток времени будет предоставлен.
        Такой механизм хорошо понятен тем, кто когда-либо участвовал в подписке на издание книг. В
        советское время такие книги так и назывались – подписные издания. Вот и в крудфандинге в
        абсолютном большинстве случаев идет оплата будущего продукции или будущего участия в
        интересном действии. Но не обязательно так. Могут быть вознаграждения совершенно
        неожиданные. Посетите сайт – платформу, где публикуются краудфандинговые проекты, и вы
        увидите, какое формы вознаграждений там предлагаются (planeta.ru и boomstarter.ru).{" "}
      </p>
      <p>
    ...
    >
      ...
      <div className={style.pic}>
        <img src="/assets/sitting-and-smiling.jpg" />
      </div>
      <p>
      ...
      <p>
        ...
        пафосно это не звучало, построение общества доверия друг к другу. Умение играть в длинную -
        это значит, требовать в равной степени, как от государства, так и от себя лично, ответа, что
        будет с нами через 5 лет, и через 10, и даже дальше.
      </p>
      <p>
    ...
    >
      ...
      <p>
        ...
        нельзя. Работу с проектом надо тщательно планировать и осмысленно оформлять. Чем тщательнее
        подготовлен проект, тем выше вероятность сбора. Если вы родили что-то сырое, и в таком виде
        выплюнули на платформу, при этом у вас нет ни вашей аудитории, нет аудитории первой волны, у
        вас нет никаких предварительных договоренностей со средствами массовой информации, то вы не
        собираете ничего. Это уже проверено 550 раз. Хотите доказать обратное? Попробуйте. Я каждый
        раз предлагаю всем оппонентам – пожалуйста, сделайте по-другому и докажите мне обратное. Но
