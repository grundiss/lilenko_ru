...
export default () => (
  <Page>
    <Section title="Консалтинг" className={style.section}>
      ...
      <ul>
        <li>Рекомендации по плану подготовки именно вашего проекта к публикации;</li>
        <li>
          Рекомендации по оформлению проекта и по организации информации о вашем проекте, чтобы
          добиться максимального отклика аудитории;
        </li>
        <li>Рекомендации по перечню мероприятий во время сбора средств на площадке.</li>
      </ul>
      <p>Ответы на все вопросы о возможностях крауда именно для вашего проекта.</p>
      <p>
        Продолжительность одной консультации не менее 2 часов. В некоторых случаях требуется больше.
        Вы сами определите после первой консультации нужно ли вам дополнительное время.
      </p>
      <p>Индивидуальное консультирование только по предварительной записи.</p>
      <div>
        <Subscribe
          id="consult-me"
