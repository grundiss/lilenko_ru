...
export default () => (
  <Page>
    <Section title="Школа">
      <p>
        Кто не любит учиться, читая книги, а предпочитает слушать преподавателя и разглядывать
        иллюстрации, может записаться в школу краудфандинга. Это серия специально разработанных
        уроков. Интересно и доходчиво здесь будет рассказываться обо всем, что известно самому
        автору этих уроков, и поверьте, это совсем немало, а главное, всё на практических примерах.
        Объем курса вы выбираете сами.
      </p>
