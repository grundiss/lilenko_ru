    ...
    <div className={cx(style.promo, sectionStyle.section)}>
      ...
      <div className={style.promoColumn}>
        ...
        <p>
          ...
          и опыт четырех это разный опыт. Я рада, что только после десятка проектов на книгу нашелся
          издатель и очень благодарна тем, кто в пятнадцатом году делать книгу побоялись. И это
          правило. Тогда краудфндинг был слишком юн и мало кому понятен и известен, хотя бы как
          термин.
        </p>
        <p>
          Сейчас совсем другое дело. Занятно, что неудачных проектов меньше не стало, но стало
          больше проектов вообще. Люди приходят на крауд-площадки, запускают проекты и не собирают.
          И это очень жаль, потому что иногда отличные идеи не находят финансирования только потому,
          что автор не владеет краудфандингом как инструментом. Учебник нужен и полезен тем, кто
          хочет гарантированного привлечения финансирования.{" "}
        </p>
        <p>
